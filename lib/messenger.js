...
/**
 *  Send a message following the Generic Template format described in
 *  https://developers.facebook.com/docs/messenger-platform/send-api-reference/generic-template
 *  This simply formats the message data properly to match what is expected by
 *  the Messenger Platform.
 *
 *  @param {String} recipientId: the id of the user to send the message to.
 *  @param {Array} elements: array of data for configuring each bubble in the
...
/**
 *  Send a message following the Button Template format described in
 *  https://developers.facebook.com/docs/messenger-platform/send-api-reference/button-template
 *  This simply formats the message data properly to match what is expected by
 *  the Messenger Platform.
 *
 *  @param {String} recipientId: the id of the user to send the message to.
 *  @param {String} text: a text message that will appear in the main body of
 *      the message, above the buttons.
